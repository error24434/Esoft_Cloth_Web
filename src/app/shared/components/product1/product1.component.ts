...
export class Product1Component {
  ...
  addProduct(event: any) {
    ...
    this.product = {
      ...
      total: parseFloat(this.priceProd.replace("LKR", "")) * this.quantity,
    }
  ...
  // Add to Cart
  this.product.total = parseFloat(this.priceProd.replace("LKR", "")) * this.product.quantity;
  this.dataService.addCart(this.product);
  ...
  products: any[] = [
    {
      ...
      img: '../../../../assets/img/products/common.png',
      mark: 'adidas',
